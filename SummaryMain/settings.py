"""
Django settings for SummaryMain project.
...
SECRET_KEY = '#tk(f!2i9ren))(t#oa!+#42l*u0z0wd&d(yjfbi#nye56flqb'
...
WSGI_APPLICATION = 'SummaryMain.wsgi.application'
